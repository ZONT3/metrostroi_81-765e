...
if SERVER then
    ...
    if not isfunction(HexToColor) then
        ...
        -- https://github.com/Facepunch/garrysmod/blob/master/garrysmod/lua/includes/util/color.lua#L119-L161
        -- Some players don't have that clientside global function for some reason

        local hex_to_dec = {}
        for code = 48, 57 do  -- '0'–'9'
            hex_to_dec[code] = code - 48
        end

        for code = 65, 70 do  -- 'A'–'F'
            hex_to_dec[code] = code - 55
        end

        for code = 97, 102 do  -- 'a'–'f'
            hex_to_dec[code] = code - 87
        end
        ...
        function HexToColor(hex)
            ...
            if len == 3 or len == 4 then
                ...
                if not (r and g and b and a) then return error("invalid hex input: " .. hex) end
            ...
            elseif len == 6 or len == 8 then
                ...
                if not (r1 and r2 and g1 and g2 and b1 and b2 and a1 and a2) then return error("invalid hex input: " .. hex) end

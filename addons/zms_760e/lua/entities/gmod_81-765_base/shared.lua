...
ENT.Version = "0.11.0-dev1"
ENT.IkVersion = "1.11.0-dev1"
...
function ENT:InitializeSounds()
    ...
    self.SoundNames["async1"] = { "subway_trains/765/rumble/engines/inverter.wav", loop = true }
    ...
    self.SoundNames["compressor"] = { loop = true, "subway_trains/765/rumble/compressor_loop.wav" }
    ...
    self.SoundPositions["compressor_pn1"] = { 800, 1e9, Vector(-118, -40, -66) }
    self.SoundNames["compressor_pn2"] = "subway_trains/765/rumble/compressor_dhm_2.wav"
    self.SoundPositions["compressor_pn2"] = { 800, 1e9, Vector(-118, -40, -66) }

    self.SoundNames["release"] = { loop = true, "subway_trains/765/rumble/pneumo_release2.wav" }
    self.SoundPositions["release"] = { 320, 1e9, Vector(-183, 0, -70), 0.4 }
...
local curIdx = 0
local lasty = nil
local function pvzSnd(val) return val and "sf_on" or "sf_off" end
